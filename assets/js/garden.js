...
Garden.prototype = {
    ...
    createRandomBloom: function (x, y) {
				...
				var c = Garden.randomrgba(Garden.options.color.rmin, Garden.options.color.rmax, Garden.options.color.gmin, Garden.options.color.gmax, Garden.options.color.bmin, Garden.options.color.bmax, Garden.options.color.opacity);
				var pc = Garden.randomInt(Garden.options.petalCount.min, Garden.options.petalCount.max);
